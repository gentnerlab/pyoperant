...
class PlacePrefExp24hr(base.BaseExp):
    ...
    def session_main(self):
        ...
        ## while the session is in daylight
        while self.check_session_schedule() == True:
            '''
        ...
        ## while it is nighttime, enter alternative nighttime loop
        while self.check_session_schedule() == False:
            '''
            Try to open all perches. The program loops in open_all_perches
            until a valid perching has been detected.
            '''
